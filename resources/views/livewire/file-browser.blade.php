<div>
    <div class="flex flex-wrap items-center justify-between mb-4">
        ...
        <div class="order-2">
            <div>
                <button class="bg-gray-200 px-6 h-12 rounded-lg mr-2" wire:click.prevent="$set('creatingNewFolder', true)">
                    New folder
                </button>
                <button class="bg-blue-600 text-white px-6 h-12 rounded-lg mr-2 font-bold" wire:click.prevent="$set('showingFileUploadForm', true)">
                    Upload Files
                </button>
            </div>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody>
                    @if ($creatingNewFolder)
                        <tr class="border-gray-200 border-b-2 hover:bg-gray-100">
                            <td class="p-3">
                                <form class="flex items-center" wire:submit.prevent="createFolder">
                                    <input type="text" name="" id="" class="w-full px-3 h-10
                                        border-2 border-gray-200 rounded-lg mr-2" wire:model="newFolderState.name" />
                        ...
                        <tr class="border-gray-100 @if (!$loop->last) border-b-2 @endif hover:bg-gray-100">
                            <td class="py-2 px-3 flex items-center">
                                @if ($child->objectable_type === 'file')
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-700 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
